/* Everaldo Gomes - 15/10/2012
   ...
   Foi chamado de inverso porque ordena no sentido da direita para esquerda
...
int main(){
  ...
  puts("Ordenando o vetor pelo método misto (mistura de Bubble Sort com Select Sort) - invertido - direita para esquerda");
